...
public class MainActivity extends BaseActivity implements ConversionListener {
    ...
    private void init(){
        ...
        binding.conversationResyclerView.setAdapter(conversationAdapter);
    ...
    private final EventListener<QuerySnapshot> eventListener = (value, error) -> {
            ...
            if(value != null) {
                ...
                binding.conversationResyclerView.smoothScrollToPosition(0);
                binding.conversationResyclerView.setVisibility(View.VISIBLE);
